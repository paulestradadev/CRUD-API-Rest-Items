...
public class ItemServiceImpl  implements ItemService{
	...
	public Response<List<Item>> read() {
		try {
			...
			log.error("Error inesperado al listar items: " + e);
	...
	public Response<Item> create(Item item) {
		...
		try {
			...
			log.error("Error inesperado al crear un nuevo item: " + e);
	...
	public Response<Item> buscar(Long id) {
		try {
			...
			log.error("Error inesperado al buscar un item: " + e);
	...
	public Response<Item> update(Item item) {
		try {
			...
			log.error("Error inesperado al actuallizar un item: " + e);
	...
	public Response<Boolean> delete(Long id) {
		try {
			...
			log.error("Eror inesperado al eliminar un item: " + e);
